...
const ptPT = {
  ...
  publicNav: {
    ...
    product: "Produto",
    legal: "Confiança",
    prelaunch: "Pré-lançamento · sem dados reais",
  },
  nav: {
    today: "Hoje",
    schedule: "Agenda",
  ...
  shell: {
    ...
    mobileNavigation: "Navegação principal em telemóvel",
...
const ptBR: typeof ptPT = {
  ...
  shell: {
    primaryNavigation: "Navegação principal",
    mobileNavigation: "Navegação principal no celular",
    localDemo: "demonstração local",
    fictionalData: "Dados fictícios",
    expandNavigation: "Expandir navegação",
    collapseNavigation: "Recolher navegação",
